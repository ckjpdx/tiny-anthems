...
function PortfolioWorks(){
  ...
  return (
    <div className="PortfolioWorks">
      <p>
        Since 2018, over 60 humans, a few animals, one mythical creature, and several businesses have been carefully immortalized in song. Below is a handful of recent works commissioned by actual strangers. Approved works are available on most streaming platforms.
      </p>
      <div className="works-area">
        ...
        <Player
        trackTitle="Bill and Penni, Tolerating One Another for 26,000,000 Minutes"
        ...
        streamUrl="https://firebasestorage.googleapis.com/v0/b/tiny-anthems-2043a.appspot.com/o/examples%2FCait%2C%20Who%20Never%20Surrendered%20To%20Law%20Enforcement%20(She_s%20No%20Criminal).mp3?alt=media&token=7dcd106a-2c6e-41bc-904f-e5648fd4a113"
        />
        <p>
        This song was composed for someone’s wife as a Christmas gift. Sharing her affinity for swimming and some other details, I conceived of a song in the form of a podcast about how her supernaturally good swimming skills got her tangled up with local law enforcement. It is presently being pressed to vinyl.
        </p>
        <Player
        trackTitle="Dave, Specializing In Felines and Sports, But Not At The Same Time"
        ...
        streamUrl="https://firebasestorage.googleapis.com/v0/b/tiny-anthems-2043a.appspot.com/o/examples%2FPortland%20Monthly%2C%20You%20Delivered%20Us%20From%20Our%20Waking%20Nightmare%20(Let%20Us%20Rejoice%20In%20Song).mp3?alt=media&token=60601868-d1f8-4179-8f6b-3e42a9e6c33d"
        />
        <p>
        ...
        <Player
        trackTitle="Roons, Portland's Confectionary Miracle That Lifted Me From The Wretched Sinkhole That Was My Old Life (A Review)"
        streamUrl="https://firebasestorage.googleapis.com/v0/b/tiny-anthems-2043a.appspot.com/o/examples%2FRoons%2C%20Portland_s%20Confectionary%20Miracle%20That%20Lifted%20Me%20From%20The%20Wretched%20Sinkhole%20That%20Was%20My%20Old%20Life%20(A%20Review).mp3?alt=media&token=4007dac5-4a02-4e61-bdc9-cec663c81ee7"
        />
      </div>
    </div>
  );
