export const faqArr = [
  ...
  `Once I complete a work I will notify you that it is ready and you can access and download it from the user page on the website. For those seeking physical copies of their anthem, I’m happy to send a tape or CD with custom art for free or a Vinyl record at an additional cost.`,
  `How much does it cost?`,
  `Tiny Anthems works on a sliding scale. This means that you pay what you feel is commensurate with your income and interest in supporting the arts. No request will be denied due to financial constraints. I suggest that $100-$300 is a reasonable range, given the time involved in the process. Note that 20% of my fee goes directly to a local non-profit.`,
